...
class Menu:
    ...
    def __init__(self, name, obj1, obj2, obj3, obj4, value1, value2, value3, value4, x, y):
        ...
        self.checkbutton2 = Checkbutton(window, text=self.obj2+": "+str(self.value2)+"€", bg="royalblue", height=5, relief=RAISED, borderwidth=5, width=14, var=self.rb2)
        self.checkbutton2.place(x=self.x+150, y=self.y+40)
        self.checkbutton3 = Checkbutton(window, text=self.obj3+": "+str(self.value3)+"€", bg="royalblue", height=5, relief=RAISED, borderwidth=5, width=14, var=self.rb3)
